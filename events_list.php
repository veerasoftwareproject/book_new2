        ...
        <div class="content-body">
			<div class="container-fluid">
				...
				<div class="modal fade" id="addProjectSidebar">
                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Events Report</h4>
                            </div>
                            <div class="card-body">
					...
					$qr=mysqli_query($link,"select * from tblevent where event_name!=''");					
                    while($dt=mysqli_fetch_array($qr)){ ?>

										<tr>
                                                <td><?php echo$dt['event_date'];  ?></td>
                                                <td><?php echo$dt['event_time'];  ?></td>
                                                <td><?php echo$dt['event_no'];  ?></td>
                                                <td><?php echo$dt['event_name'];  ?></td>
                                                <td><?php echo$dt['guest_name'];  ?></td>
                                                <td><?php echo$dt['event_msg'];  ?></td>   
                                                <td><?php echo$dt['remark'];  ?></td>    
												<td style="visibility:hidden;"><?php echo$dt['id']; ?></td> 
                                                <td class="btnSelect">
                                                	<div class="d-flex">
														<a href="#" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-del">X</i></a>
													</div>
												</td>                                                                                                                                        
                                            </tr>
