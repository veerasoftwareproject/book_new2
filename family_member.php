                                    ...
                                    <form>
                                        <div class="form-row">                                            
                                          <label class="col-sm-2 col-form-label"">Family No:</label>
                                            <div class="col-sm-2">
                                                <input type="text" class="form-control" id='fh1' placeholder="">
                                            </div>
                                        ...
                                        <div class="form-row">                                            
                                          <label class="col-sm-2 col-form-label"">SL.No:</label>
                                            <div class="col-sm-2">
                                                <input type="text" class="form-control" placeholder="" id="fa1">
                                            </div>
										...
										<div class="form-row">                                            
                                          <label class="col-sm-2 col-form-label"">Relation:</label>
                                            <div class="col-sm-2">
                                                <input type="email" class="form-control" id="fa4" placeholder="">
                                            </div>
                                            <label class="col-sm-2 col-form-label">Occupation:</label>
                                            <div class="col-sm-2">
                                                <input type="email"  id="fa5" class="form-control" placeholder="">
                                            </div>
                                            <label class="col-sm-2 col-form-label"">DOB:</label>
                                            <div class="col-sm-2">
                                            <input type="email" class="form-control" id="fa6" placeholder="">
                                            </div>                                                                                                                                                              
                                        </div>   
                                        <br>
                                        <div class="form-row">                                            
                                          <label class="col-sm-2 col-form-label"">Marriage.Date:</label>
                                            <div class="col-sm-2">
                                                <input type="date" class="form-control" id="fa7" placeholder="">
                                            </div>
                                            <label class="col-sm-2 col-form-label">Baptism.Date:</label>
                                            <div class="col-sm-2">
                                                <input type="date" id="fa8" class="form-control" placeholder="">
                                            </div>
                                            <label class="col-sm-2 col-form-label"">Mobile:</label>
                                            <div class="col-sm-2">
                                            <input type="number" id="fa9" class="form-control" placeholder="">
                                            </div>                                                                                                                                                              
                                        </div>    
                                        <br>
                                        <div class="form-row">                                            
                                          <label class="col-sm-2 col-form-label"">Aadhaar No:</label>
                                            <div class="col-sm-2">
                                                <input type="date" id="fa10" class="form-control" placeholder="">
                                            </div>
                                            <label class="col-sm-2 col-form-label">Joining.Date:</label>
                                            <div class="col-sm-2">
                                                <input type="date" id="fa11" class="form-control" placeholder="">
                                            </div>
                                            <label class="col-sm-2 col-form-label"">Status:</label>
                                            <div class="col-sm-2">
                                            <input type="number" id="fa12" class="form-control" placeholder="">
                                            </div>                                               
                                        </div>    
                                        ...
                                        <div class="form-row">                                            
                                          <label class="col-sm-2 col-form-label"">Are you saved?</label>
                                            ...
                                            <div class="col-sm-2">
											<select  id="fa15" class="form-control">
													<option>- Select - </option>
													<option value="Street1">option 1 </option>
                                                    <option value="Street2">option 2</option>
                                                    <!-- <option></option> -->
                                                    <!-- <option>Others</option>                                                     -->
                                                </select>
												</div>									
                                    <div class="col-sm-2">                                             
									<button  style="float:right;" type="button" id="btn_next" class="btn btn-primary">ADD NEW</button>    

								</div>                                         
                                    </div>    <br>

										    <!-- <button  style="float:right; cursor:pointer;" type="button"  class="btn btn-secondary" id="btn_next" >NEXT</button>     -->
											<div class="col-xl-12 col-lg-12">
                        <div class="card">
                            <div class="card-header">
                            ...
                            <div class="table-responsive">
								...
								<br>
								<button  style="float:right;" type="button" class="btn btn-success" id="btnconfirm">CONFIRM</button>    
			...
			// alert("page load");
             $("#btn_next").click(function(){
				// alert("17 columns");
                 var fa1 = $("#fa1").val();
				 var fa2 = $("#fa2").val();
				 var fa3 =  $("input[name='h1']:checked").val();				 
                 var fa4 = $("#fa4").val();
				 var fa5 = $("#fa5").val();
				 var fa6 =  $("#fa6").val();				 
                 var fa7 = $("#fa7").val();
				 ...
				 var fa11 =  $("#fa11").val();				 
                 var fa12 = $("#fa12").val();
				 var fa13 = $("input[name='a1']:checked").val();			
				 var fa14 =  $("#fa14").val();	
				 var fa15 =  $("#fa15").val();	
				//  var fa14 =  $("#fa14").val();					 				 			 
				var row_data = "<tr ><td id='td_delete'><div class='d-flex'><a style='cursor:pointer;' class='btn btn-primary shadow btn-xs sharp mr-1'><i class='fa fa-eye'></i></a></div></td><td class='faa1'>"+fa1+"</td><td class='faa2'>"+fa2+"</td><td class='faa3'>"+fa3+"</td><td class='faa4'>"+fa4+"</td><td class='faa5'>"+fa5+"</td><td class='faa6'>"+fa6+"</td><td class='faa7'>"+fa7+"</td><td class='faa8'>"+fa8+"</td><td class='faa9'>"+fa9+"</td><td class='faa10'>"+fa10+"</td><td class='faa11'>"+fa11+"</td><td class='faa12'>"+fa12+"</td><td class='faa13'>"+fa13+"</td><td class='faa14'>"+fa14+"</td><td class='faa15'>"+fa15+"</td></tr>"; 
    ...
    $("#btnconfirm").click(function(){
      ...
      $.ajax({
        ...
        success:function(response){
          alert("Family Members data collected");
        }
      });
