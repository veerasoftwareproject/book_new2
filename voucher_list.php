        ...
        <div class="content-body">
			<div class="container-fluid">
				...
				<div class="modal fade" id="addProjectSidebar">
                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Voucher Report</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="example" class="display" style="min-width: 845px">
                                        <thead>
                                            <tr>
                                                <th>Date</th>
                                                <th>Particulars</th>
                                                <th>Amount</th>    <th style="visibility:hidden;">ID</th>
                                                <!-- <th>AB/PRE</th>
                                                <th>REMARKS</th> -->
                                                <th>ACTION</th>
                                            </tr>
					...
					$qr=mysqli_query($link,"select * from tblvoucher where vno!=''");					
                    while($dt=mysqli_fetch_array($qr)){ ?>
                                          
										
										<tr>
                                                <td><?php echo$dt['voucher_date']; ?></td>
                                                <td><?php echo$dt['description']; ?></td>
                                                <td><?php echo$dt['amount']; ?></td>
												<td style="visibility:hidden;"><?php echo$dt['id']; ?></td>
                                                <td class="btnSelect">
                                                	<div class="d-flex">
														<a href="#" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa">X</i></a>
													</div>
												</td>
                                            </tr>
...
<script>
	$(document).ready(function(){
		$(".btnSelect").click(function(){
			...
			var id = crow.find("td:eq(3)").html();
			alert("id:"+id);
			$(this).closest("tr").remove();
			$.ajax({
				url:"voucher_delete.php",
				method:"GET",
				data:{id:id},
