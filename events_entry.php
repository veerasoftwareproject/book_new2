            ...
            <div class="header-content">
				...
				<div class="sub-header">
					<div class="d-flex align-items-center flex-wrap mr-auto">
						<h5 class="dashboard_bar">EVENTS ENTRY</h5>
					</div>
                                    ...
                                    <form action="event_insert.php" method="post">
                                        ...
                                        <div class="form-row">                                            
                                          <label class="col-sm-4 col-form-label"" style="text-align:right;" >Time:</label>
                                            <div class="col-sm-6">
                                                <input type="time" class="form-control" placeholder="" name="event_time">
                                            </div>
                                        </div><br>                                        

                                        <div class="form-row">                                            
                                          <label class="col-sm-4 col-form-label"" style="text-align:right;" >Event Number:</label>
                                            <div class="col-sm-2">
                                                <input type="email" class="form-control" name="event_no" readonly value="001">
                                            </div>
                                        </div><br>

                                        <div class="form-row">                                            
                                          <label class="col-sm-4 col-form-label"" style="text-align:right;">Name of the Event:</label>
                                            <div class="col-sm-8">
                                        ...
                                        <div class="form-row">                                            
                                          <label class="col-sm-4 col-form-label"" style="text-align:right;">Guest Name:</label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-row">                                            
                                          <label class="col-sm-4 col-form-label"" style="text-align:right;">Message:</label>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" name="event_msg">
                                            </div>
                                        </div><br>
                                        <div class="form-row">                                            
                                          <label class="col-sm-4 col-form-label"" style="text-align:right;">Remarks:</label>
                                          <div class="col-sm-8">
