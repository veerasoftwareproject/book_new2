                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form>
                                        <div class="form-row">                                            
                                          <label class="col-sm-2 col-form-label"">Family Head:</label>
                                            <div class="col-sm-2">
                                                <input type="email" class="form-control" placeholder="">
                                            </div>
                                            <label class="col-sm-2 col-form-label">F.NO</label>
                                            <div class="col-sm-2">
                                                <input type="email" class="form-control" placeholder="">
                                            </div>
                                        ...
                                        <br>
                                        <div class="form-row">                                            
                                          <label class="col-sm-2 col-form-label"">Date.Baptism:</label>
                                            <div class="col-sm-2">
                                        ...
                                        <div class="form-row">                                            
                                          <label class="col-sm-2 col-form-label"">Are you saved?</label>
                                            <div class="col-sm-2">
                                                <input type="radio" value="a1" class=""> Yes    
                                                <input type="radio" value="a1" class=""> No
                                            </div>
