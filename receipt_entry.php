            ...
            <div class="header-content">
				...
				<div class="sub-header">
					<div class="d-flex align-items-center flex-wrap mr-auto">
						<h5 class="dashboard_bar">RECEIPT ENTRY</h5>
					</div>
                                    ...
                                    <form action="receipt_insert.php" method="post">
                                        <div class="form-row">                                            
                                          <label class="col-sm-4 col-form-label"" style="text-align:right;">Date:</label>
                                            <div class="col-sm-6">
                                                <input type="date"  value="<?php echo date('Y-m-d'); ?>" class="form-control" name="receipt_date">
                                            </div>
                                        </div><br>

                                        <div class="form-row">                                            
                                          <label class="col-sm-4 col-form-label"" style="text-align:right;">Receipt Number:</label>
                                            <div class="col-sm-2">
                                        ...
                                        <div class="form-row">                                            
                                          <label class="col-sm-4 col-form-label"" style="text-align:right;">Offering:</label>
                                            <div class="col-sm-8">
                                                <select class="form-control" name="offering">
                                                    <option>Box </option>
                                                    <option>Macheiney</option>
                                                    <option>Poor Offering</option>
                                                    <option>Others</option>                                                    
                                                </select>
                                            </div>
                                        </div><br>
                                        <div class="form-row">                                            
                                          <label class="col-sm-4 col-form-label"" style="text-align:right;">Received with:</label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-row">                                            
                                          <label class="col-sm-4 col-form-label"" style="text-align:right;">Particulars:</label>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" name="description">
                                            </div>
                                        </div><br>
                                        <div class="form-row">                                            
                                          <label class="col-sm-4 col-form-label"" style="text-align:right;">Amount Type:</label>
                                          <div class="col-sm-8">
                                        ...
                                        <div class="form-row">                                            
                                          <label class="col-sm-4 col-form-label"" style="text-align:right;">Amount:</label>
                                            <div class="col-sm-6">
                                        ...
                                        <label class="col-sm-8 col-form-label""></label>
                                            <div class="col-sm-2">
                                            <button type="submit" class="btn btn-secondary">RECEIPT</button>
                                            </div>      </center>
                                    </form>
                                </div>
                            </div>
