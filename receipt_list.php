        ...
        <div class="content-body">
			<div class="container-fluid">
				...
				<div class="modal fade" id="addProjectSidebar">
					...
					$qr=mysqli_query($link,"select * from tblreceipt where rno!=''");					
                    while($dt=mysqli_fetch_array($qr)){ ?>                                  
									
										<tbody>
                                            <tr>
                                                <td><?php echo$dt['receipt_date']; ?></td>
                                                <td><?php echo$dt['description']; ?></td>
                                                <td><?php echo$dt['amount'];  ?></td>
												<td style="visibility:hidden;"><?php echo$dt['id']; ?></td>
                                                <td class="btnSelect">
                                                	<div class="d-flex">
														<a href="#" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-delete">X</i></a>
													</div>
												</td>
                                            </tr>
