    ...
    <div id="main-wrapper">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<span class="nav-text">FAMILY MEMBERS</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="form-wizard.html">NEW MEMBER</a></li>
							<li><a href="table-datatable-basic.html">EDIT/DELETE</a></li>
                            </li>
						</ul>
                    </li>
					
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<span class="nav-text">DOB REPORTT</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="chart-flot.html">EDIT/DELETE</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<span class="nav-text">WEDDING REPORT</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="ui-accordion.html">EDIT/DELETE</a></li>
                       </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<span class="nav-text">BAPHISM</span>
						</a>
                    </li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<span class="nav-text">RECIPT ENTRY</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="receiptentry.php">New</a></li>
                            <li><a href="receipt 1.html">Edit/Delete</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    	    <span class="nav-text">VOCHER ENTRY</span>
                        </a>
                        <ul aria-expended="false">
                    	    <li><a href="voch 1.html">New</a></li>
                    	    <li><a href="voch 2.html">Edit/Delete</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<span class="nav-text">WEEKLY ENTRY</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="page-register.html">EDIT/DELETE</a></li>
                        </ul>
                    </li>
                </ul>
			</div>
      ...
      <div class="row">
        <div class="col-sm-10 grid-margin">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">DAILY ENTRY</h5>
              ...
              <form>
                ...
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-3 col-form-label">R.No</label>
                  <div class="col-sm-5">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-7">
                    <select name="offering" class="form-select" aria-label="Default select example">
                ...
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-3 col-form-label">Other Offering</label>
                  <div class="col-sm-5">
                    <input type="text" class="form-control" name="offering_with">
                  </div>
                </div>

                <div class="row mb-3">
                  <label for="inputText" class="col-sm-3 col-form-label">Received with</label>
                  <div class="col-sm-5">
