            ...
            <div class="header-content">
				...
				<div class="sub-header">
					<div class="d-flex align-items-center flex-wrap mr-auto">
                        ...
                        <h4 class="welcome-text">Hi, welcome back!</h4>					
                    </div>
        ...
        <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="chart-flot.html">New Family</a></li>
                            <li><a href="chart-morris.html">Edit/Delete</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="ui-accordion.html">Entry Page</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <!-- <li><a href="uc-select2.html">New Receipt </a></li> -->
                            <li><a href="uc-nestable.html">Report</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="table-bootstrap-basic.html">New Voucher</a></li>
