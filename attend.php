...
// while($d1=mysqli_fetch_array($qr)){ 
// if($d1['flno']!=''){	
// $no = $d1['flno'];
// }
// else{
...
// }
// $count=0;			
// select* from employees where flno in (select * from tblattend	 where DATE_FORMAT(created_at,'%d-%m-%Y')='$date');


$qr="select* from tblfamily_member where not slno in (select flno from tblattend where DATE_FORMAT(created_at,'%d-%m-%y')='$date')";
...
while($dt=mysqli_fetch_array($qr)){  $count++;?>                                  
                                        ...
                                        <tbody>
                                            <tr id="">
                                                <td><?php echo$dt['fno']; ?></td>
                                                <td><?php echo$dt['family_head_name']; ?></td>
                                                <td><?php echo$dt['family_member_name']; ?></td>
                                                <td><?php echo$dt['slno']; ?></td>
												<td class="btnSelect_1"><span style="cursor:pointer; color:green;" class="material-symbols-outlined">check_box</span></td>
												<td><input type="text" name="" placeholder="Reason"></td>
												...
												<td><?php echo$dt['member_status']; } ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
