...
$a1 = new batman();
$link = $a1->info();
$qr=mysqli_query($link,"select * from tblfamily_member where fno!=''");					
while($dt=mysqli_fetch_array($qr)){ ?>                                  
										...
										<tr>
                                                ...
                                                <td><?php echo$dt['family_photo']; ?></td>
                                                <td><?php echo$dt['slno']; ?></td>
												<td><?php echo$dt['family_member_name']; ?></td>
                                                <td><?php echo$dt['gender']; ?></td>
                                                <td><?php echo$dt['relation']; ?></td>
												<td><?php echo$dt['occupation']; ?></td>
                                                <td><?php echo$dt['dob']; ?></td>
                                                <td><?php echo$dt['marriage_date']; ?></td>
												<td><?php echo$dt['baptism_date']; ?></td>
                                                <td><?php echo$dt['mobile']; ?></td>
                                                <td><?php echo$dt['ad_no']; ?></td>
												<td><?php echo$dt['joining_date']; ?></td>
                                                <td><?php echo$dt['member_status']; ?></td>
                                                <td><?php echo$dt['member_saved']; ?></td>
                                                <td><?php echo$dt['member_photo']; ?></td>
                                                <td><?php echo$dt['street'];  ?> </td>
...
<script>
	$(document).ready(function(){
		$('.btnSelect').click(function(){
			...
			var slno = currentRow.find("td:eq(4)").html();
			alert("Slno:"+slno);
			$.ajax({
				url:"family_memeber_delete.php",
				method:"GET",
				data: {slno:slno},
