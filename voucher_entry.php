            ...
            <div class="header-content">
				...
				<div class="sub-header">
					<div class="d-flex align-items-center flex-wrap mr-auto">
						<h5 class="dashboard_bar">Voucher Entry</h5>
					</div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="voucher_insert.php" method="post">
                                        <div class="form-row">                                            
                                        ...
                                        <div class="form-row">                                            
                                          <label class="col-sm-4 col-form-label"" style="text-align:right;" >Voucher Number:</label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-row">                                            
                                          <label class="col-sm-4 col-form-label"" style="text-align:right;">Paid to:</label>
                                            <div class="col-sm-2">
