            ...
            <div class="header-content">
				...
				<div class="sub-header">
					<div class="d-flex align-items-center flex-wrap mr-auto">
						<h5 class="dashboard_bar">Present/Absent Edit</h5>
					</div>
                                    ...
                                    <form action="event_insert.php" method="post">
                                        <div class="form-row">                                            
                                          <label class="col-sm-4 col-form-label"" style="text-align:right;">Date:</label>
                                            <div class="col-sm-6">
                                                <input type="date" id="created_at" class="form-control" value="<?php echo date('Y-m-d'); ?>" placeholder="" name="event_date">
                                            </div>
                                        </div><br>
                                         <center>
                                        <label class="col-sm-8 col-form-label""></label>
                                            <div class="col-sm-2">
                                            <a href="#" id="btnchange" class="btn btn-primary">CHANGE</a>
                                            </div>      </center>
                                    </form>
                                </div>
                            </div>
...
<script>
	$(document).ready(function(){
		$("#btnchange").click(function(){
			...
			alert("created date:"+created_at);
			window.location.href="attend_edit.php?created_at="+created_at;
			// $.ajax({
			// 	url:"attend_edit.php",
			// 	method:"GET",
